  ...
  Widget build(BuildContext context) {
    ...
    child: MainDrawer(),
      ...
      body: Column(
        ...
        children: <Widget>[
      Text('I am mudassar shah', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 30.0, color: Colors.white),),
      SizedBox(height: 30.0),
      Text("Registration No : SP17-BCS-072",style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20.0, color: Colors.white),),
      SizedBox( height: 30.0),
